...
def create_groups num_top=40,max_children=3,max_depth=7,prefix='top'
  ...
  for i in 0..num_top
    ...
    rules = gen_rules
    tree["Autogroup #{child_prefix}"] = { 'rules' => rules, 'children' => create_groups(num_groups,max_children,new_depth,child_prefix), 'classes' => {} }
  end
  tree
end

puts create_groups.to_yaml
